...
public class TreatmentProxy implements ITreatment
{
    ...
    {
        System.out.println("[INFO] LogModel before method parameter1="+parameter1+", parameter2="+parameter2);
    }

    private void afterTreatment(int parameter1, int parameter2)
    {
        System.out.println("[INFO] LogModel after method parameter1="+parameter1+", parameter2="+parameter2);
    }
